...
Vite offers two official React plugins:
...
This is now **fully copy-paste ready** for `README.md`, with:

-✅ Correct Vite port (`5173`)  
-✅ Proper folder tree formatting  
-✅ Clean Vite plugin explanation  
-✅ Everything else untouched from your original file  
